...
Sys.time()
system.time(
  chains1<-coda.samples(jm,variable.names=var_names,n.iter=100000, thin=200))/3600

Sys.time()
system.time(
  chains2<-coda.samples(jm,variable.names=var_names,n.iter=100000, thin=200))/3600
...
Sys.time()
system.time(
  chains3<-coda.samples(jm,variable.names=var_names,n.iter=400000, thin=200))/3600
...
Sys.time()
system.time(
  chains4<-coda.samples(jm,variable.names=var_names,n.iter=400000, thin=200))/3600
