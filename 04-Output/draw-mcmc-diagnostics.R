...
traceplot(chains[,"aS"],main=expression("aS"), cex.main=1.5)
traceplot(chains[,"bS"],main=expression("bS"), cex.main=1.5)
...
plot(density(chains[,"cvmuD"][[1]]), main="cvmuD", ylim=c(0,8))
